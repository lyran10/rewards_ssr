...
export const DistrictList = ({list, handleClick, current, selectedMenuItem} : MenuListProps) => {
  
  return (
    <>
    {
     list.length ? list.map((item : {parent : Menu, district : Menu[], ulb : Menu[]}) => {
          return(
            item.ulb.sort((a : Menu,b : Menu) => a.linkText.localeCompare(b.linkText))
